...
function MainInput() {
  return (
    <form className='w-full relative p-3 flex items-center shadow-lg mt-auto'>
       ...
       <button type='button' className='absolute left-4 btn btn-ghost btn-circle text-2xl text-[#686B6E]'>
        <CiMicrophoneOn/>
       </button>
       <button type='submit' className='absolute right-8 btn btn-ghost text-2xl text-white'>
        <FiSend/>
       </button>
    </form>
  )
